...
<div class="w-full max-w-xs login">
  <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="post">
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Enter email" name="username">
    </div>
    <div class="mb-6">
  ...
  <p class="text-center text-gray-500 text-xs">
    &copy;2023 @VOCAL FOR LOCAL. All rights reserved.
  </p>
</div>
</div>
</body>
